...
do
    ...
    rawset = function(t, k, v)
        if k == nil and #_G._nil_traces < 5 then
            table.insert(_G._nil_traces, debug.traceback("NIL KEY in rawset", 2))
        end
...
try:
    ...
    print(f'Error after {_time.time()-t0:.1f}s: {str(e)[:500]}')

print('\n=== NIL KEY TRACES ===')
traces = runtime.lua.globals()['_nil_traces']
count = 0
